...
En el caso de la consulta de las revisiones, adicionalmente a los parámetros de búsqueda, está el parámetro \texttt{sort} que permite, por fecha de extracción, el
...
El cálculo de estas métricas toma como parámetros múltiples atributos, tales como: el título del artículo o la fecha de extracción, para poder filtrar el numero total revisiones de la consulta.
Estos parámetros pasan por un proceso de aceptación, en donde solo son aceptados aquellos que estén ya incluidos en una lista llamada lista blanca, mientras que el resto son ignorados.
Después de esta etapa, se genera una tarea de Celery para poder ser procesada en segundo plano hasta obtener el resultado.

En la tabla \ref{tab:count} se puede apreciar con detalle, por medio de sus historias, los filtros aceptados por cada métrica.
