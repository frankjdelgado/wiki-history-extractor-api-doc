...
En MongoDB se hace uso de grupos de réplicas (replica sets) para almacenar las copias de datos en múltiples
servidores de base de datos. Un grupo de réplicas previene los tiempos de inactividad de la base de datos
en caso de errores y ayuda a escalar las operaciones de lectura. La recuperación de un miembro del grupo de
réplicas se realiza de forma automática. En un grupo de réplicas cualquier miembro puede actuar como nodo principal
